...
export class SimpleSearchComponent implements OnInit {
    ...
    constructor(public nav : NavbarService, private reviewService : ReviewsService, private recommendationService : RecommendationsService, private movieService : MoviesService, private userService : UsersService, private favoriteService : FavoritesService,) {}
    ...
    addFavorites(name : string) {
        ...
        this.movieService.getMovieByName(name).subscribe((data) => {
